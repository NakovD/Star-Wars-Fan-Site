...
**Single character details page** <br/>
route: '/charDetails/:id'<br/>
...
**Edit a character page** <br/>
route: '/editChar/:idChar'<br/>
...
imgURL
description<br/>
**Add character page** <br/>
route: '/addCharacter'<br/>
...
**Create discussion page** <br/>
route: '/createDiscussion'<br/>
...
**Discussion page** <br/>
route: '/discussion/:discussionId'<br/>
...
**Edit discussion page** <br/>
route: '/editDisc/:discId' <br/>
